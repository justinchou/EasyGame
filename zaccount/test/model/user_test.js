    ...
    describe('#Account 检测Account数据表处理函数', () => {
        ...
        it('Load User #Exist', done => {
            UserModel.userInfo(userid, (err, info) => {
                ...
                Should.equal(info.lv, AccountConfig.user.lv);
                Should.equal(info.exp, AccountConfig.user.exp);
                Should.equal(info.coins, AccountConfig.user.coins);
                Should.equal(info.gems, AccountConfig.user.gems);
                done();
            });
        });
        ...
        it('Load User Pri #Exist', done => {
            UserModel.userPriInfo(userid, (err, info) => {
                ...
                Should.equal(info.exp, AccountConfig.user.exp);
                Should.equal(info.coins, AccountConfig.user.coins);
                Should.equal(info.gems, AccountConfig.user.gems + amount);
                done();
            });
        });
        ...
        it('Load User Pri #Exist', done => {
            UserModel.userPriInfo(userid, (err, info) => {
                ...
                Should.equal(info.lv, AccountConfig.user.lv);
                Should.equal(info.exp, AccountConfig.user.exp);
                Should.equal(info.coins, AccountConfig.user.coins + amount);
                Should.equal(info.gems, AccountConfig.user.gems);
                done();
            });
        });
        ...
        it('Load User Pri #Exist', done => {
            UserModel.userPriInfo(userid, (err, info) => {
                Should.equal(err, null);
                Should.equal(info.lv, AccountConfig.user.lv + amount);
                Should.equal(info.exp, AccountConfig.user.exp);
                Should.equal(info.coins, AccountConfig.user.coins);
                Should.equal(info.gems, AccountConfig.user.gems);
                done();
        ...
        it('Load User Pri #Exist', done => {
            UserModel.userPriInfo(userid, (err, info) => {
                Should.equal(err, null);
                Should.equal(info.lv, AccountConfig.user.lv + amount);
                Should.equal(info.exp, AccountConfig.user.exp + amount);
                Should.equal(info.coins, AccountConfig.user.coins);
                Should.equal(info.gems, AccountConfig.user.gems);
                done();
            });
